    ...
    <div id="wrapper">
        ...
        <nav id="menu">
            ...
            <ul>
                ...
                <li><a href="{{ route('index') }}">Introducción a la arquitectura Cliente/Servidor.</a></li>
                <li><a href="{{ route('index2') }}">Componentes y características del Cliente/Servidor.</a></li>
